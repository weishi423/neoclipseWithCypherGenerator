 ...
 * 
 */
public class GenerateEntityAction extends AbstractConnectionTreeAction
{

    public GenerateEntityAction()
    {
        super( Actions.GENERATE_ENTITY );
    }
    ...
    public void run()
    {
        try
        {
            GenerateEntityDialog dlg = new GenerateEntityDialog( Display.getCurrent().getActiveShell() );
            dlg.open();
        }
        catch ( Exception e )
        {
